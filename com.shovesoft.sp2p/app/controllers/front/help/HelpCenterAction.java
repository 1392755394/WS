...
public class HelpCenterAction extends BaseController {
	 ...
	 * 首页
	 */
	public static void index(long typeId, String currPage, String pageSize,
			String keyword) {
		ErrorInfo error = new ErrorInfo();
		List<v_news_types> types = NewsType.queryTypeAndCount(
				NewsTypeId.HELP_CENTER, error);
		...
		PageBean<t_content_news> pageBean = News.queryNewsByTypeId(typeId + "",
				currPage, pageSize, keyword, error);
	...
	public static void partner(int currPage, int pageSize) {
		...
		PageBean<t_content_advertisements_partner> page = News.queryPartners(
		...
		render(page, products, creditLevels, id);
	}
