...
public class CPSSpreadAction extends SupervisorController {
	 ...
	 * 查询GPS会员明细
	 */
	public static void CPSDetail(String sign, Date beginTime, Date endTime, int currPage, String name,int pageSize) {
	...
	public static void CPSRebateStatistic(int year, int month, int currPage) {
		PageBean<v_user_cps_offer_info> page = User.queryCpsOfferInfo(1L, year, month, currPage);
