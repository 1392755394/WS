...
//	}
	 ...
	 * 
	 * ***/
	public static void exportBillDept(){
		
		ErrorInfo error = new ErrorInfo();
		
		List<v_bill_department_month_maturity>  details =  Bill.queryBillMaturity();
		...
		File file = ExcelUtils.export("本月到期账单", arrDetails, new String[] { "借款人",
				"借款标编号", "借款金额", "年利率", "账单标题", "账单期数", "还款时间", "逾期时长", "逾期账单", "客服"},
				new String[] { "name", "bid_no", "amount", "apr",
						"title", "period", "repayment_time", "overdue_time","overdue_count",
						"supervisor_name" });
