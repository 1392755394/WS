...
public class OverBorrowAction extends SupervisorController {
	 ...
	 * 超额借款列表
	 */
	public static void overBorrows(int currPage, int pageSize, int keywordType, String keyword, int orderType) {
		ErrorInfo error = new ErrorInfo();
		PageBean<v_user_over_borrows> pageBean = 
		OverBorrow.queryOverBorrows(currPage, pageSize, keywordType, keyword, orderType, error);
	...
	public static void overBorrowDetails(long id) {
		...
		render(user, preOverBorrowId, nextOverBorrowId, preOverBorrowCount, laterOverBorrowCount, creditRecord, items, 
				historyOverBorrows, auditingOverBorrow, passedAuditItemsCount, suggestPassAmount);
	}
