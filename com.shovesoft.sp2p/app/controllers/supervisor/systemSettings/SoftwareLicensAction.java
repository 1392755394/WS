...
public class SoftwareLicensAction extends SupervisorController {
	...
	public static void basicInfo() {
		...
		List<t_dict_ad_provinces> provinces = (List<t_dict_ad_provinces>) Cache
				.get("provinces");
		long provinceId = BackstageSet.getProvince(backstageSet.companyCity,
				error);
	...
	public static void saveSystemData() {
		...
		backstageSet.contactMobile2 = params.get("contactMobile1");
	...
	public static void notRegister() {
		List<t_dict_ad_provinces> provinces = (List<t_dict_ad_provinces>) Cache
				.get("provinces");
		// List<t_dict_ad_citys> citys = (List<t_dict_ad_citys>)
		// Cache.get("citys");
		BackstageSet backstageSet = BackstageSet.getCurrentBackstageSet();
	 ...
	 * 保存正版软件提交信息
	 */
	public static void saveSoftwareLicens(String companyNameService,
			String province, String city, String companyDomain,
			String registerCode) {
		ErrorInfo error = new ErrorInfo();
