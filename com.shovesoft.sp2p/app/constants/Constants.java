...
public class Constants {
	...
	public static final String BASE_URL = Play.configuration
			.getProperty("test.application.baseUrl");
	public static final String SQL_PATH = Play.configuration
			.getProperty("sql.path"); // 数据库备份文件路径
	public static final String ENCRYPTION_KEY = Play.configuration
			.getProperty("fixed.secret"); // 加密key
	public static final String APP_ENCRYPTION_KEY = Play.configuration
			.getProperty("fixed.secret"); // APP加密key
	public static final String TRUST_FUNDS = "true"; // 资金托管模式
	public static final boolean IPS_ENABLE = Convert.strToBoolean(
			Play.configuration.getProperty("pay.trustFunds"), false); // 是否开启资金托管模式
	 ...
	 * 校验手机验证码
	 */
	public static final boolean CHECK_CODE = true;
	...
	public static final String RESET_PASSWORD_EMAIL = BASE_URL
			+ "front/account/resetPassword?sign=";
	public static final String RESET_QUESTION_EMAIL = BASE_URL
			+ "front/account/resetQuestion?sign=";
	public static final String ACTIVE_EMAIL = BASE_URL
			+ "front/account/accountActivation?sign=";

	/**
	 * 环迅
	 */
	public static final long IPS_GATEWAY = 2;
	public static final String IPS_MERCHANT_URL = BASE_URL
			+ Play.configuration.getProperty("ips_merchant_url", "");
	public static final String IPS_URL = Play.configuration.getProperty(
			"ipsURL", "");
	...
	public static final long CBP_GATEWAY = 3;
	public static final String CBP_URL = Play.configuration.getProperty(
			"cbpURL", "");
	public static final String CBP_MER_URL = BASE_URL
			+ Play.configuration.getProperty("call_mer_url", "");
	...
	public static final long BF_GATEWAY = 4;
	public static final String BF_URL = Play.configuration.getProperty("bfURL",
			"");
	public static final String BF_BACK = BASE_URL + Play.configuration.getProperty(
			"bfBACK", "");;
			
	public static final String ReturnUrl =BASE_URL +Play.configuration.getProperty("bfBackReturn","");		
	...
	public static final long HC_GATEWAR = 5;

	public static final String HC_URL = Play.configuration.getProperty("hcURL",
			"");

	public static final String HC_BACK = BASE_URL +Play.configuration.getProperty(
			"hcBACK", "");
	public static final String HC_BACKAJ = BASE_URL +Play.configuration.getProperty(
			"hcBACKAJ", "");
	...
	public static final String WEIXIN_BASEINFO_TOKEN=BASE_URL + Play.configuration.getProperty("token","");
	public static final String WEIXIN_BASEINFO_APPID=BASE_URL + Play.configuration.getProperty("appId","");
	public static final String WEIXIN_BASEINFO_appSecret=BASE_URL + Play.configuration.getProperty("appSecret","");

	/**
	 * 国付宝
	 */
	public static final long GO_GATEWAY = 1;
	public static final String GO_MER_URL = BASE_URL
			+ Play.configuration.getProperty("go_mer_url", "");
	public static final String GO_URL = Play.configuration.getProperty(
			"go_url", "");
	public static String GO_SERVER_TIME_URL = Play.configuration.getProperty(
			"gopay_server_time_url", "");
	...
	public static final int HOME_SHOW_AMOUNT = 8; // 首页显示产品数量
	 ...
	 * 标
	 */
	public static final int USER_BALANCE_EXCEPTION = -999; // 资金异常
	...
	/* 所有标相关的排序数组 */
	public static final String[] BID_SEARCH_ORDER = { " ORDER BY id desc",
			" ORDER BY user_item_count_true/product_item_count ",
			" ORDER BY time ", " ORDER BY amount ",
			" ORDER BY credit_level_id ", " ORDER BY loan_schedule ",
			" ORDER BY apr ", " ORDER BY product_id ",
			" ORDER BY mark_overdue_time ", " ORDER BY overdue_count ",
			" ORDER BY last_repay_time ", " ORDER BY mark_bad_time ",
			" ORDER BY audit_time ", " ORDER BY real_invest_expire_time " };

	/* 会员资料审核排序数组 */
	public static final String[] ITEMS_SEARCH_ORDER = { " ORDER BY time desc",
			" ORDER BY sum_count ", " ORDER BY audited_count ",
	...
	public static final String[] QUERY_CUSTOMER_KEYWORD_TYPE = {// 全部，编号，姓名，手机，邮箱
			...
			" and (customer_num like ?) ", " and (reality_name like ?) ",
			" and (mobile1 like ?) ", " and (email like ?) " };
	...
	public static final String[] QUERY_EVENT_KEYWORD = {
			...
			" and (ip like ?) ", " and (descrption like ?) ",
	...
	// {"and (email like ? or name like ?) ", "and email like ? ",
	// "and name like ? "};

	public static final String[] ORDER_TYPE = { "register_time desc",
			"recharge_amount asc", "recharge_amount desc", "invest_amount asc",
			"invest_amount desc", "invest_count asc", "invest_count desc",
			"bid_amount asc", "bid_amount desc", "bid_count asc",
			"bid_count desc", "num asc", "num desc", "audit_item_count asc",
			"audit_item_count desc" };

	public static final String[] ORDER_TYPE_CPS_DETAIL = { "time desc",
			"time ", "time desc", "recommend_count ", "recommend_count desc",
			"active_rate ", "active_rate desc", "commission_amount ",
	...
	public static final String[] LOAN_USER_ORDER = { "", "bid_count asc",
			"bid_count desc", "overdue_bill_count asc",
			"overdue_bill_count desc", "bad_bid_count asc",
			"bad_bid_count desc", "audit_item_count asc",
			"audit_item_count desc" };

	public static final String[] INVEST_USER_ORDER = { "", "invest_count asc",
			"invest_count desc", "invest_amount asc", "invest_amount desc",
			"num asc", "num desc", "user_amount asc", "user_amount desc" };

	public static final String[] COMPLEX_USER_ORDER = { "", "invest_count asc",
			"invest_count desc", "invest_amount asc", "invest_amount desc",
			"num asc", "num desc", "user_amount asc", "user_amount desc",
			"bid_amount asc", "bid_amount desc", "repayment_amount asc",
			"repayment_amount desc" };

	public static final String[] VIP_USER_ORDER = { "", "invest_count asc",
			"invest_count desc", "invest_amount asc", "invest_amount desc",
			"num asc", "num desc", "bid_count asc", "bid_count desc",
			"bid_amount asc", "bid_amount desc", "audit_item_count asc",
			"audit_item_count desc" };

	public static final String[] CPS_TYPE = {
			"and (email like ? or name like ? or recommend_user_name like ?) ",
			"and email like ? ", "and name like ? ",
			"and recommend_user_name like ? " };

	public static final String[] CPS_USER_ORDER = { "",
			"commission_amount asc", "commission_amount desc",
			"invest_amount asc", "invest_amount desc", "bid_amount asc",
			"bid_amount desc", "recharge_amount asc", "recharge_amount desc" };
	...
	public static final String[] LOCKED_USER_ORDER = { "",
			"recharge_amount asc", "recharge_amount desc", "lock_time asc",
			"lock_time desc", "user_amount asc", "user_amount desc" };

	public static final String[] REPORTED_USER_ORDER = { "",
			"reported_count asc", "reported_count desc", "user_amount asc",
			"user_amount desc" };

	public static final String[] BLACK_USER_ORDER = { "", "reported_count asc",
			"reported_count desc", "num asc", "num desc", "user_amount asc",
			"user_amount desc" };

	/**
	 * 前台--cps推广
	 */
	public static final String[] MY_CPS = { "", "and is_active = 1 ",
			"and is_active = 0 " };
	public static final String[] WITHDRAWAL_TYPE = { "", "and status = 2 ",
			"and status = 0 ", "and status = 1 ", "and status = -1 " };
	...
	public static final String[] C_TYPE = {
			"and (bid_no like ? or name like ? or bill_no like ?) ",
			"and bid_no like ? ", "and name like ? ", "and bill_no like ? " };

	public static final String[] BILL_ORDER_Maturity = { "",
			"repayment_time asc", "repayment_time desc", "apr asc", "apr desc",
			"amount asc", "amount desc", "overdue_time asc",
			"overdue_time desc", "overdue_count asc", "overdue_count desc" };

	public static final String[] BILL_ORDER_PAID = { "", "repayment_time",
			"repayment_time desc", "apr", "apr desc", "amount", "amount desc",
			"overdue_time", "overdue_time desc", "" };

	public static final String[] BILL_ORDER_OVERDUE = { "",
			"repayment_time asc", "repayment_time desc", "apr asc", "apr desc",
			"amount asc", "amount desc", "overdue_time asc",
			"overdue_time desc", "late_penalty asc", "late_penalty desc" };

	public static final String[] BILL_ORDER_RECEIVE = { "",
			"repayment_time asc", "repayment_time desc", "apr asc", "apr desc",
			"amount asc", "amount desc", "overdue_time asc",
			"overdue_time desc", "real_repayment_time asc",
			"real_repayment_time desc" };

	public static final String[] BILL_ORDER_RECEVIABLE = { "",
			"bills_timely_completion_rate asc",
			"bills_timely_completion_rate desc", "overdue_counts asc",
			"overdue_counts desc", "uncollected_rate asc",
			"uncollected_rate desc" };

	public static final String[] BILL_ORDER_REPAYMENT = { "",
			"receive_time asc", "receive_time desc", "pay_amount asc",
			"pay_amount desc", "overdue_time asc", "overdue_time desc" };

	public static final String[] BILL_ORDER_INVEST = { "",
			"ontime_complete_rate asc", "ontime_complete_rate desc",
			"principal_advances_rate asc", "principal_advances_rate desc",
			"nopaid_rate asc", "nopaid_rate desc", "nopaid_amount asc",
			"nopaid_amount desc" };

	public static final String[] BILL_ORDER_STATUS = { "", "and status = 0 ",
			"and status = -2 " };
	public static final String[] INVEST_BILL_HAS_PAID = { "",
			" receive_time asc ", " receive_time desc ", " pay_amount asc ",
			" pay_amount desc", " real_receive_time asc ",
			" real_receive_time desc" };

	/**
	 * 后台--提现管理
	 */
	public static final String[] WITHDRAWAL_ORDER_TYPE = { "",
			"order by time asc", "order by time desc", "order by amount asc",
			"order by amount desc", "order by audit_time asc",
	...
	public static final String[] SIDE = {
			"and (from_pay like ? or to_receive like ?) ",
			"and to_receive like ? ", "and from_pay like ? " };

	public static final String[] TYPE = { "and (type = 2 or type = 1) ",
	...
	public static final String[] BID_APR_CONDITION = { " ", " and apr <= 10 ",
			"  and apr > 10 and apr < 15 ", " and apr >= 15 and apr <= 20  ",
			" and apr > 20 " };

	public static final String[] BID_AMOUNT_CONDITION = { " ",
			" and amount <= 100000 ",
			"  and amount > 100000 and amount <= 500000  ",
			" and amount > 500000 and amount <= 1000000 ",
			"  and amount > 1000000 and amount <= 3000000 ",
			"  and amount > 3000000 " };

	public static final String[] BID_LOAN_SCHEDULE_CONDITION = { " ",
			" and loan_schedule <= 50 ",
			" and loan_schedule > 50  and loan_schedule <=80 ",
			" and loan_schedule > 80  and loan_schedule <100 ",
			" and loan_schedule =100 " };

	public static final String[] BID_ORDER_CONDITION = { " ",
			" order by amount desc ", " order by apr desc ",
			" order by loan_schedule desc ", " order by repayment_time desc " };

	public static final String[] DEBT_AMOUNT_CONDITION = { " ",
			"  and  debt_amount <= 1000 ",
			"  and  debt_amount > 1000  and debt_amount <=5000 ",
			"  and  debt_amount > 5000   and debt_amount <=10000 ",
			"  and  debt_amount > 10000 and  debt_amount <=30000 ",
			"  and  debt_amount > 30000 " };

	public static final String[] DEBT_ORDER_CONITION = { " ",
			"  order by  debt_amount desc ", "    order by  apr desc ",
			"    order by  end_time desc ",
			"    order by  repayment_time desc " };

	public static final String[] TRANSFER_MANAGEMENT_STATUS_CONDITION = { " ",
			" and status = 0 ", " and status = 1  or status = 2",
			" and status = 3 ",
	...
	public static final String[] LOAN_BILL_ALL = { "and title like ? ",
			"and title like ? " };
	...
	public static final String[] LOAN_INVESTBILL_ALL = { "and title like ? ",
			"and title like ? " };
	...
	public static final String[] INVEST_STATISTICS = { "",
			"order by invest_fee_back desc ", "order by invest_fee_back ",
			"order by average_invest_amount desc ",
			"order by average_invest_amount ", "order by invest_count desc ",
	...
	public static final String[] AUDIT_ITEMS_ORDER_TYPE = {
			...
			" order by risk_control_ranking ", " order by submit_per desc",
			" order by submit_per ", " order by relate_overdue_bid_num desc",
	...
	public static final String[] AUDIT_ITEMS_CONDITION = {
			" and (no like ? or name like ?)", " and (no like ?)",
			" and (name like ?)" };

	/**
	 * 借款情况统计分析表-排序类型
	 */
	public static final String[] BORROW_ORDER_TYPE = { " order by id desc",
			" order by id desc", " order by month desc", " order by month ",
			" order by total_borrow_amount desc",
			" order by total_borrow_amount ", " order by overdue_per desc",
			" order by overdue_per ", " order by bad_bill_amount_per desc",
			" order by bad_bill_amount_per " };

	/**
	 * 借款标销售情况分析表-排序类型
	 */
	public static final String[] PRODUCT_ORDER_TYPE = { " order by id desc",
			" order by id desc", " order by released_bids_num desc",
			" order by released_bids_num ",
			" order by average_bid_amount desc",
			" order by average_bid_amount ", " order by success_bids_num desc",
			" order by success_bids_num " };

	/**
	 * 借款标销售情况分析表-搜索关键字
	 */
	public static final String[] PRODUCT_CONDITION = { " and (name like ?)",
			" and (name like ?)", };

	/**
	 * 充值统计表-排序类型
	 */
	public static final String[] RECHARGE_ORDER_TYPE = { " order by id desc",
			" order by id asc", " order by id desc",
			" order by recharge_amount asc", " order by recharge_amount desc",
			" order by recharge_menber asc", " order by recharge_menber desc",
	 ...
	 * 保障本金统计分析表-排序类型
	 */
	public static final String[] SECURITY_ORDER_TYPE = { " order by id desc",
			" order by id asc", " order by id desc",
			" order by bad_debt_income_rate asc",
			" order by bad_debt_income_rate desc", " order by pay asc",
			" order by pay desc", " order by advance_acount asc",
			" order by advance_acount desc", };

	/**
	 * 会员数据统计分析表-排序类型
	 */
	public static final String[] MEMBER_ORDER_TYPE = { " order by id desc",
			" order by id asc", " order by id desc",
			" order by new_member asc", " order by new_member desc",
			" order by new_recharge_member asc",
			" order by new_recharge_member desc", };

	public static final String[] IPS_TYPE = { "01", "128", "04", "16", "32",
			"1024" };
	public static final String[] GO_TYPE = { "ICBC", "CMB", "CCB", "ABC",
			"BOC", "SPDB", "CIB", "BOBJ", "CEB", "BOCOM", "CMBC", "CITIC",
			"GDB", "PAB", "PSBC", "SRCB", "BOS", "HXBC", "TCCB", "NBCB", "NJCB" };
	 ...
	 * QQ授权地址
	 */
	public static final String AUTHORIZATIONURL_QQ = Play.configuration
			.getProperty("authorizationURL_QQ", "");

	/**
	 * 获取QQ令牌地址
	 */
	public static final String ACCESSTOKENURL_QQ = Play.configuration
			.getProperty("accessTokenURL_QQ", "");

	/**
	 * QQ客户id
	 */
	public static final String CLIENTID_QQ = Play.configuration.getProperty(
			"clientid_QQ", "");

	/**
	 * QQ客户密码
	 */
	public static final String SECRET_QQ = Play.configuration.getProperty(
			"secret_QQ", "");

	/**
	 * QQ响应类型
	 */
	public static final String RESPONSETYPE_QQ = Play.configuration
			.getProperty("responseType_QQ", "");

	/**
	 * 获取QQ应用平台id地址
	 */
	public static final String GETOPENIDURL_QQ = Play.configuration
			.getProperty("getOpenIDURL_QQ", "");

	/**
	 * 获取QQ用户信息地址
	 */
	public static final String GETUSERINFOURL_QQ = Play.configuration
			.getProperty("getUserINFOURL_QQ", "");
	 ...
	 * 微博授权地址
	 */
	public static final String AUTHORIZATIONURL_WB = Play.configuration
			.getProperty("authorizationURL_WB", "");

	/**
	 * 获取微博令牌地址
	 */
	public static final String ACCESSTOKENURL_WB = Play.configuration
			.getProperty("accessTokenURL_WB", "");

	/**
	 * 微博客户id
	 */
	public static final String CLIENTID_WB = Play.configuration.getProperty(
			"clientid_WB", "");

	/**
	 * 微博客户密码
	 */
	public static final String SECRET_WB = Play.configuration.getProperty(
			"secret_WB", "");

	/**
	 * 微博响应类型
	 */
	public static final String RESPONSETYPE_WB = Play.configuration
			.getProperty("responseType_WB", "");

	/**
	 * 获取微博用户信息地址
	 */
	public static final String GETUSERINFOURL_WB = Play.configuration
			.getProperty("getUserINFOURL_WB", "");
	...
	public static final int SELL_SERVICE_DATE = 3; // 售后服务到期时间(年单位)
	...
	public static final int ORDINARY_WELFARE = 3; // 手工充值
	public static final int ORDINARY_NEWUSER = 4; // 手工充值
	...
	public class RechargeType {
		...
		public static final int ItemAudit = 1;
		public static final int VIP = 2;
		public static final int welfare = 3;//公益充值
	}
