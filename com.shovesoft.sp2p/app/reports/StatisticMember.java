...
public class StatisticMember {
	...
	private static int add(ErrorInfo error) {
		...
		entity.new_member_recharge_rate = queryNewMemberRechargeRate(error);
	...
	public static int queryNewMember(ErrorInfo error){
		...
		try {
			count = (int) GenericModel.count("date_format(time, '%y%m%d') = date_format(curdate(), '%y%m%d')");
		} catch (Exception e) {
			e.printStackTrace();
	...
	public static int queryNewVipCount(ErrorInfo error){
		...
		try {
			count = (int) GenericModel.count("vip_status = 1 and date_format(time, '%y%m%d') = date_format(curdate(), '%y%m%d')");
		} catch (Exception e) {
			e.printStackTrace();
	...
	public static int queryBorrowMemberCount(ErrorInfo error){
		...
		try {
			count = (int) GenericModel.count("date_format(master_time_loan, '%y%m%d') = date_format(curdate(), '%y%m%d')");
		} catch (Exception e) {
			e.printStackTrace();
	...
	public static int queryInvestMemberCount(ErrorInfo error){
		...
		try {
			count = (int) GenericModel.count("date_format(master_time_invest, '%y%m%d') = date_format(curdate(), '%y%m%d')");
		} catch (Exception e) {
			e.printStackTrace();
	...
	public static int queryCompositeMemberCount(ErrorInfo error){
		...
		try {
			count = (int) GenericModel.count("date_format(master_time_complex, '%y%m%d') = date_format(curdate(), '%y%m%d')");
		} catch (Exception e) {
			e.printStackTrace();
