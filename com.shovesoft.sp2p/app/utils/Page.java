...
public class Page  implements Serializable{
	...
	private String getMixedTheme(){
		...
		if(currPage != 1){
			strBuff.append("<a href=\""+upPage+"\"><span class=\"xf_wylc_page_prev\">上一页</span></a>");
		}
	...
	private String getForeGroundThemeScript(){
		...
		int up = (currPage-1 == 0?1:currPage-1);
		if(currPage != 1){
			strBuff.append("<span class=\"xf_wylc_page_prev\" onclick=\"javascript:"+defaultMethod+"("+up+","+pageSize+");\"><a href=\"javascript:void(0);\">上一页</a></span>");
		}
	...
	private String getBackstageTheme(){
		...
		if(currPage != 1){
			strBuff.append("<span class=\"page_prev\"><a href=\""+upPage+"\">上一页</a></span>");
		}else{
			strBuff.append("<span class=\"page_prev page_prev_no\">上一页</span>");
		}
	...
	private String getBackstageThemeScript(){
		...
		int up = (currPage-1 == 0?1:currPage-1);
		if(currPage != 1){
			strBuff.append("<span class=\"page_prev\" onclick=\"javascript:"+defaultMethod+"("+up+","+pageSize+");\"><a href=\"javascript:void(0);\">上一页</a></span>");
		}else{
			strBuff.append("<span class=\"page_prev page_prev_no\">上一页</span>");
		}
	...
	private String getDefaultTheme(){
		...
		if(currPage != 1){
			strBuff.append("<a href=\""+homeUrl+"\">首页</a>&nbsp;<a href=\""+upPage+"\">上一页</a>");
		}
	...
	private String getDefaultThemeScript(){
		...
		strBuff.append("第"+currPage+"页").append("/共"+totalPageCount+"页&nbsp;&nbsp;");
		if(currPage != 1){
			strBuff.append("<a href='javascript:"+defaultMethod+"(1,"+pageSize+");'>首页</a>&nbsp;<a href='javascript:"+defaultMethod+"("+up+","+pageSize+")'>上一页</a>");
		}
		// ---------样式 2012-07-10 增加 begin-------------
