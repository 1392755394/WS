...
//		}
	...
	public int edit(ErrorInfo error) {
		...
		try {
			rg = GenericModel.findById(this.id);
		} catch (Exception e) {
			Logger.error(e.getMessage());
			e.printStackTrace();
			error.code = -1;
	...
	public static int addSupervisor(long groupId, String supervisorName, ErrorInfo error) {
		...
		try {
			gos = GenericModel.find("supervisor_id = ? and group_id = ?", supervisorId, groupId).first();
		} catch (Exception e) {
			Logger.error(e.getMessage());
			e.printStackTrace();
			error.code = -1;
	...
	public static int delete(long groupId, ErrorInfo error) {
		...
		try {
			rg = GenericModel.findById(groupId);
		} catch (Exception e) {
			Logger.error(e.getMessage());
			e.printStackTrace();
			error.code = -1;
		...
		try {
			GenericModel.delete("group_id = ?", groupId);
			GenericModel.delete("group_id = ?", groupId);
			rg.delete();
		} catch (Exception e) {
			Logger.error(e.getMessage());
	...
	public static t_right_groups queryRightGroupById(long groupId, ErrorInfo error) {
		...
		try {
			rightGroup = GenericModel.findById(groupId);
		} catch (Exception e) {
			Logger.error(e.getMessage());
			e.printStackTrace();
			error.code = -1;
	...
	public static t_right_groups queryRightGroupByName(String name, ErrorInfo error) {
		...
		try {
			rightGroup = GenericModel.find("name=?", name).first();
		} catch (Exception e) {
			Logger.error(e.getMessage());
			e.printStackTrace();
			error.code = -1;
	...
	public static List<Long> queryRightIds(long groupId, ErrorInfo error) {
		...
		try {
			list = GenericModel.find(sql, groupId).fetch();
		} catch (Exception e) {
			Logger.error(e.getMessage());
			e.printStackTrace();
			error.code = -1;
